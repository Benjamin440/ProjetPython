   ...
   "outputs": [
    {
     ...
     "text": [
      ...
      "Nom : LE BERRE\n",
      "Prenom : Benjamin\n",
      "Numéro étudiant : 44678935\n",
      "Formation :  3 SRC 2\n",
      "Vous avez éte 2 fois absent\n",
      "Email : bleberre@myges.fr\n",
      "Login : bleberre\n",
      "Password : jyzYhwOgnTMnGj\n",
      "-----------------------------\n",
      "e3b0c44298fc1c149afbf4c8996fb92427ae41e4649b934ca495991b7852b855\n",
      "-----------------------------\n",
      "Informations de l'étudiant :\n",
      "Nom : GOUBY OLLIVER\n",
      "Prenom : Quentin\n",
      "Numéro étudiant : 65873907\n",
      "Formation :  3 SRC 2\n",
      "Vous n'avez pas été absent\n",
      "Email : qgoubyolliver@myges.fr\n",
      "Login : qgoubyolliver\n",
      "Password : T9NZyVfrXjRAiS\n",
      "-----------------------------\n",
      "e3b0c44298fc1c149afbf4c8996fb92427ae41e4649b934ca495991b7852b855\n",
      "-----------------------------\n",
      "Informations de l'étudiant :\n",
      "Nom : BONNARD\n",
      "Prenom : Esteban\n",
      "Numéro étudiant : 47362890\n",
      "Formation :  3 SRC 2\n",
      "Vous avez éte 4 fois absent\n",
      "Email : ebonnard@myges.fr\n",
      "Login : ebonnard\n",
      "Password : nssMTA7cEZPWdk\n",
      "-----------------------------\n"
     ]
    }
   ],
